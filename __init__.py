...
bl_info = {
    ...
    "version": (1, 0),
    "blender": (2, 80, 0),
    "location": "Ctrl-Shift-A in Edit Armature Mode",
    "description": "This addon add rigify's building block into a menu accessible in edit armature mode with Ctrl-Shift-A, this addon will enable rigify if it is not already enabled.",
    "warning": "",
    "doc_url": "",
    "category": "Armature",
}
